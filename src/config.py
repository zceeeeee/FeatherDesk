...
_DEFAULTS: dict[str, str] = {
    ...
    "EXPLORE_VISION_MODE": "auto",
    "EXPLORE_VISION_QUALITY_THRESHOLD": "0.45",
    "EXPLORE_VISION_MIN_CONFIDENCE": "0.65",
    "EXPLORE_VISION_MAX_ELEMENTS": "20",
    "EXPLORE_VISION_MAX_CALLS_PER_PAGE": "2",
    "EXPLORE_VISION_MAX_CALLS_PER_TASK": "5",
    "EXPLORE_VISION_TIMEOUT_MS": "30000",
    "EXPLORE_VISION_MAX_SCREENSHOT_BYTES": "4000000",
    "EXPLORE_VISION_STRONG_CANVAS_RATIO": "0.50",
    "EXPLORE_VISION_SENSITIVE_ACTION_POLICY": "block",
    "EXPLORE_OCR_ENABLED": "true",
    "EXPLORE_OCR_LANGUAGE": "zh-CN",
}
